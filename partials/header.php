            ...
            <ul class="nav navbar-nav navbar-right main-menu">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu login">
                  <li><a href="edit-profile.php">Edit Info</a></li>
                  <li><a href="change-password.php">Change Password</a></li>
                  <li><a href="functions/logout.php">Logout</a></li>
                </ul>
              </li>
             <!--  <li class="dropdown">
                <a href="#" class="dropdown-toggle pages" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Contacts <span><img src="images/down-arrow.png" alt="" /></span></a>
